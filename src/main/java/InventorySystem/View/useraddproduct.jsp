    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
            ...
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="useraddproduct.jsp"><p>Add Products</p></a>
                </li>
                <li>
                    <a href="userproductsummary.jsp"><p>Product Summary</p></a>
                </li>
                <li>
                    <a href="#"><p>About</p></a>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <div id="nav_wrapper">
                        ...
                        <ul class="center" >
                        <li><a style="font-size: 36px" href="dashboarduser.jsp">Kambi</a>
                        </li>
